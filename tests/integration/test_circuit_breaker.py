...
from ai_employee.core.workflow_engine import WorkflowStep, StepResult, StepStatus
...
class TestCircuitBreakerIntegration:
    ...
    async def test_circuit_breaker_event_publishing(self, circuit_breaker, event_bus):
        ...
        with patch('ai_employee.core.circuit_breaker.CircuitBreaker._publish_event', side_effect=event_handler):

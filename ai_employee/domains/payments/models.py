...
@dataclass
class PaymentMatch(BaseEntity):
    """Payment matching result."""
    payment_id: str
    invoice_id: str
    confidence_score: float = 0.0
    match_method: str = "reference"  # reference, amount, client, ai
    ...
    def verify(self, verified_by: str) -> None:
        ...
        Args:
            verified_by: Who verified the match
        """
        self.verified = True
    ...
    def is_medium_confidence(self) -> bool:
        ...
        Returns:
            True if confidence between 0.7 and 0.9
        """
        return 0.7 <= self.confidence_score <= 0.9

    def is_low_confidence(self) -> bool:
        """Check if match is low confidence.
